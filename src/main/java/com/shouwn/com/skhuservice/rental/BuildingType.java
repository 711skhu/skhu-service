...
public enum BuildingType {
	...
	LEECHUNHWAN_HALL(6, "이천환관", "gv건물목록_ctl06_btnSelect"),
	SSECHUNNUN_HALL(7, "새천년관", "gv건물목록_ctl07_btnSelect"),
	SUNGMIELE_HALL(9, "성미가엘성당", "gv건물목록_ctl08_btnSelect"),
	MIELE_HALL(11, "미가엘관", "gv건물목록_ctl09_btnSelect");
